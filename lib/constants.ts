...
export const countryFlagMappings: Record<string, string> = {
  'United Kingdom': 'gb',
  'UK': 'gb',
  'United States': 'us',
  'USA': 'us',
  ...
  'Vatican City': 'va',
  'Andorra': 'ad',
  // Adding all missing countries from the dropdown
  'Angola': 'ao',
  'Bahamas': 'bs',
  'Barbados': 'bb',
  'Belize': 'bz',
...
// Utility function to get country flag URL
export function getCountryFlagUrl(countryName: string): string {
  const countryCode = countryFlagMappings[countryName] || 'un'
